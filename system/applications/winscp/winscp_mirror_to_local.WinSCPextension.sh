...
#
# @option TERMINAL -run -config dropdownlist "Select your terminal" """%WINSCP_PATH%\..\..\bin\mintty.exe"" --Title LFTP4WIN_MIRROR -e /bin/bash -li" """%WINSCP_PATH%\..\conemu\ConEmu64.exe"" -run {Bash::bash} -new_console:t:LFTP4WIN_MIRROR"=conemu """%WINSCP_PATH%\..\..\bin\mintty.exe"" --Title LFTP4WIN_MIRROR -e /bin/bash -li"=mintty "wt -w 0 nt --title LFTP4WIN_MIRROR ""%WINSCP_PATH%\..\..\bin\bash.exe"" -li"=windows_terminal
#
